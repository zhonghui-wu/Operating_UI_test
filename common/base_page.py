from Operating_UI_test.common.comm_driver import CommDriver
from selenium.webdriver.support import expected_conditions as EC
from selenium.webdriver.support.wait import WebDriverWait
from Operating_UI_test.config.config import wait_poll_frequency, wait_time
from Operating_UI_test.utils.all_path import screenshots_path, log_save_path
from Operating_UI_test.utils.log import log
from Operating_UI_test.utils.get_yaml import get_yaml_data
from selenium.webdriver import ActionChains
from Operating_UI_test.utils.all_path import img_code_path
...
class BasePage():
    ...
    def save_img(self, locator):
        ...
        ele = self.get_element(locator)
        if ele:
            ele.screenshot(f'{img_code_path}')
        else:
            print('图形验证码图片保存失败！')
